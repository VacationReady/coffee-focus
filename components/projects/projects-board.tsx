...
export function ProjectsBoard({ projects }: ProjectsBoardProps) {
  ...
  return (
    <>
      ...
      {editingProject ? (
        <div className="modal-scrim" role="dialog" aria-modal="true" onClick={closeEditModal}>
          <div className="modal-card modal-card-wide" onClick={(event) => event.stopPropagation()}>
            <button type="button" className="modal-close-btn" aria-label="Close edit project" onClick={closeEditModal}>
              ×
            </button>
